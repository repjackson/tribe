Template.edit_image.events
    "change input[type='file']": (e) ->
        ...
        Cloudinary.upload files[0],
            # folder:"secret" # optional parameters described in http://cloudinary.com/deedumentation/upload_images#remote_upload
            ...
            (err,res) -> #optional callback, you can catch with the Cloudinary collection as well
                ...
                if err
                    ...
                    Deeds.update deed_id, $set: image_id: res.public_id
                return
